...
export class VaultContract extends ContractBase {
    ...
    public methods!: {
        ...
        _initialize: ((new_admin: AztecAddressLike, initial_liquidity: FieldLike) => ContractFunctionInteraction) &
        ...
        position: ((user: FieldLike, pos_id: FieldLike) => ContractFunctionInteraction) &
            Pick<ContractMethod, 'selector'>
    }
}
